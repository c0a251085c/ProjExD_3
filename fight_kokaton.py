...
class Beam:
    ...
    def __init__(self, bird: "Bird"):
        ...
        """
        self.vx, self.vy = bird.dire  # こうかとんが向いている方向をvx, vyに代入
        # 直交座標(x, -y)から極座標の角度に変換し，弧度法→度数法へ
        angle = math.degrees(math.atan2(-self.vy, self.vx))
        self.img = pg.transform.rotozoom(pg.image.load("fig/beam.png"), angle, 1.0)
        self.rct = self.img.get_rect()
        # こうかとんのwidth/heightと向いている方向を考慮した初期配置
...
class Score:
    ...
    def __init__(self):
        ...
        self.rct = self.img.get_rect()
        self.rct.center = (100, HEIGHT - 50)  # 左下に配置
...
def main():
    ...
    while True:
        ...
        for bomb in bombs:
            bomb.update(screen)
        for explosion in explosions:  # 爆発エフェクトを更新・描画
